...
locals {
  ...
  configure_ad_command_join = "Install-ADDSDomainController -DomainName ${var.active_directory_domain} -InstallDns:$true -SafeModeAdministratorPassword $password -Force:$true -Credential $Cred"
